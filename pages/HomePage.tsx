        ...
        <div className="max-w-3xl w-full text-center space-y-10">
          <motion.h1 
            ...
            <motion.p 
              ...
              One simple step at a time, Trusty helps you stay safe, confident, and in control online, backed by a vibrant group of volunteers who share your goal of staying secure.
            </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
